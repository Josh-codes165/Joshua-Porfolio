...
export function XIcon({ size = 18, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path d="M18.24 2.25h3.05l-6.66 7.62 7.84 11.88H16.1l-5.02-7.19-5.74 7.19H2.28l7.13-8.15L1.86 2.25h6.68l4.53 6.57 5.17-6.57Zm-1.07 17.6h1.69L6.9 4.06H5.08l12.09 15.79Z" />
    </svg>
  );
}
